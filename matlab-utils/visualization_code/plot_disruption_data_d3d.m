function [d_data, nd_data, d_shots, nd_shots] = plot_disruption_data_d3d(shotlist, varargin)
...
data = cell2mat(fetch(db, ['select shot, time, time_until_disrupt, ip, ', ... 
    'ip_error, dipprog_dt, ', strjoin(parameters, ','), ' from disruption_warning_d3d ',...
...
for i = 7:size(d_data,2)
   ...
   saveas(f,['/home/tinguely/Disruptions/Disruption_warning_data_figures/d3d_2015/', parameters{i-6}, '.fig'])
...
%   saveas(f,['/home/tinguely/Disruptions/Disruption_warning_data_figures/', parameters{i-6}, '.pdf'])
   save('/home/tinguely/Disruptions/Disruption_warning_data_figures/d3d_2015/data.mat', 'd_data', 'nd_data', 'parameters')
