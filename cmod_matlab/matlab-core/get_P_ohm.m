...
% Ryan Sweeney 2019/01 - made sure that both P_ohm and V_loop were returned as
%                        arrays of NaN in the various checks (in some cases,
%                        only P_ohm was intialized and returned)		    				
