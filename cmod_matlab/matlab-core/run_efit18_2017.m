% Get list of all disruption shots and times in the C-Mod 2017 campaign

db = set_database('logbook');
result = fetch(db, ['select shot, t_disrupt from disruptions where ' ...
  'shot between 1170101000 and 1171231999 order by shot']);
close(db);
...
% All plasma shots in 2017 have the standard EFIT data at 20 ms intervals
