...
if __name__ == '__main__':
    ...
    parser.add_argument('--order', type=str, default='THESIS_ORDER', choices=['DEFAULT_ORDER', 'THESIS_ORDER', 'DATASET_ORDER'])
