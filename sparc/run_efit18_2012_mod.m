% Get list of all disruption shots and times in the C-Mod 2012 campaign

db = set_database('logbook');
%result = fetch(db, ['select shot, t_disrupt from disruptions where ' ...
%  'shot between 1120101000 and 1121231999 order by shot']);

result = fetch(db, ['select shot, t_disrupt from disruptions where ' ...
  'shot between 1120914032 and 1121231999 order by shot']);
...
% All plasma shots in 2012 have the standard EFIT data at 20 ms intervals
