...
for ishot = 1:nshots;
  ...
  if (early_li_mean < 1.0 && early_li_std < 0.05 && ...
    ...
    li_highlighted_shotlist = [li_highlighted_shotlist,...
        shotlist_disrupt_2015(ishot)];
...
hold off;
print('li_behavior_disrupt.png', '-dpng');
save('li_behavior_data.mat')