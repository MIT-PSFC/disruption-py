...
ylim([0.00, 0.12]);
set(gca, 'fontsize', 12);
xlabel('Greenwald\_fraction', 'fontsize', axis_label_size);
ylabel('probability histogram', 'fontsize', axis_label_size);
%title('Histograms of l_i for DIII-D', 'fontsize', title_size);
hold on;
...
ylim([0.00, 0.07]);
set(gca, 'fontsize', 12);
xlabel('beta\_p', 'fontsize', axis_label_size);
ylabel('probability histogram', 'fontsize', axis_label_size);
%title('Histograms of l_i for DIII-D', 'fontsize', title_size);
hold on;
...
ylim([0.00, 0.06]);
set(gca, 'fontsize', 12);
xlabel('Te\_HWHM', 'fontsize', axis_label_size);
ylabel('probability histogram', 'fontsize', axis_label_size);
%title('Histograms of l_i for DIII-D', 'fontsize', title_size);
hold on;
...
ylim([0.00, 0.12]);
set(gca, 'fontsize', 12);
xlabel('v\_loop', 'fontsize', axis_label_size);
ylabel('probability histogram', 'fontsize', axis_label_size);
%title('Histograms of l_i for DIII-D', 'fontsize', title_size);
hold on;
...
xaxis_d3d = [-1.05, -0.95, -0.85, -0.75, -0.65, -0.55, -0.45, -0.35, -0.25, -0.15,-0.05];
...
h1 = histogram(li(ii_01), bins, 'normalization', 'probability' , ...
  'facecolor', 'blue');
h_low = histogram(li(ii_00), bins, 'normalization', 'probability' , ...
  'facecolor', 'blue');
...
mean_li(12) = xcentroid(bin_centers, h_low.Values);
