...
def get_custom_kappa_area(params: PhysicsMethodParams):
    aminor = params.get_data(r"\efit_aeqdsk:aminor", tree_name="_efit_tree")
    area = params.get_data(r"\efit_aeqdsk:area", tree_name="_efit_tree")
    times = params.get_data(r"\efit_aeqdsk:time", tree_name="_efit_tree")
