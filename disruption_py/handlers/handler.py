...
class Handler(ABC):
    ...
    @classmethod
    def _get_shot_data(cls, shot_id, shot_manager : ShotManager, shot_settings: ShotSettings) -> pd.DataFrame:
        """
        ...
        try:
            ...
            cls.logger.warning(f"[Shot {shot_id}]: fatal error {traceback.format_exc()}")
