...
def physics_method(
    ...
    `run_methods`, `run_tags`, or `run_columns` attributes of the `RetrievalSettings` class, and if included inside of the
    `custom_physics_methods` argument of the `retrieval_settings` or in the built-in method list. If run the result of the decorated
