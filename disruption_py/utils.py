...
def get_bolo(shot_id, bol_channels, bol_prm, bol_top, bol_time, drtau=50):
    ...
    aperx = np.array([234.953, 234.953, 234.953, 234.953, 234.953, 234.953, 234.953,
    ...
    apery = np.array([72.990, 72.990, 72.990, 72.990, 72.990, 72.990, 72.990,
    ...
    angle = np.array([269.449, 265.689, 261.923, 258.163, 254.406, 250.901, 247.898,
