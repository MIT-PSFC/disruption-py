...
def get_bp_sensor_category(sensor_name: str) -> str:
    """Get the category of a Bp sensor based on its name.
    
    Parameters
    ----------
    sensor_name : str
        The name of the sensor (key from D3D_SENSORS_BP dictionary)
    ...
    ------
    ValueError
        If the sensor name is not found in D3D_SENSORS_BP
    
    Examples
    --------
    >>> get_bp_sensor_category('MPI11M322')
    'Bp_322_deg_pol_array'
    >>> get_bp_sensor_category('MPI2A067')
