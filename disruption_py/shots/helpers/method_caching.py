...
def parameter_cached_method(
    ...
    def tag_wrapper(func):
        ...
        wrapper.cached_method_params = (
            ParameterCachedMethodParams.from_cached_method_params(
                wrapper.cached_method_params, columns, tags
            )
        )
...
def cached_method(
    ...
    def tag_wrapper(method):
        ...
        def wrapper(*args, **kwargs):
            ...
            cache_key = get_method_cache_key(method.__name__, shot_props.times) + str(
                other_params
            )
