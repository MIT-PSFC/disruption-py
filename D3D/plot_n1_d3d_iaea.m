...
if exist('n_equal_1_mode','var')==0;
  result = fetch(dbconn,['select n_equal_1_mode from ' ...
    'disruption_warning order by shot, time']);
  n_equal_1_mode = cell2mat(result);
end;
