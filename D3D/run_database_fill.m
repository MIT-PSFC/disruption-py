...
%
%*********************
shotlist = dlmread('/fusion/projects/disruption_warning/matlab_programs/shotlist2016.txt');
shotlist = shotlist(1258:1259);
for ishot = 1:nshots;
  shot = shotlist(ishot);
...
% Get EFIT parameters
  ...
  [beta_n, beta_p, dbetap_dt, kappa, upper_gap, lower_gap, ...
    li, dli_dt, q0, qstar, q95, v_loop_efit, Wdiam, dWmhd_dt] = ...
...
% Get Te profile width (from Thomson scattering data)
  ...
  [Te_HWHM] = get_TS_data( shot, times_for_db);
